...
\cite{Avis80,Deza97,Koolen00}, and even the classification of the extreme rays of the
...
\bibitem{Deposit}
D.V.~Feldman and E.R.~Kehoe, \textit{Lean~4 formalization of ``Every separable metric space
extends to an extreme one''}, Zenodo, DOI to appear.
...
metrics and half-one extremality, companion paper, arXiv:XXXX.XXXXX.
